            ...
            <Navbar.Collapse>
              {localStorage.getItem("jwtToken") !== null && (
                ...
                >
                  ...
                  <Nav.Link>
                    <LinkContainer
                      to={data !== null ? `/cart/user=${data.name}` : "/"}
                    >
                      <svg
                  ...
                  <NavDropdown
                    title={data !== null ? <b>{data.name}</b> : ""}
                    id="navbarScrollingDropdown"
                  >
                    <LinkContainer
                      to={data !== null ? `/profile/user=${data.name}` : "/"}
                    >
                      <NavDropdown.Item>Profile</NavDropdown.Item>
                    </LinkContainer>

                    <LinkContainer
                      to={data !== null ? `/user=${data.name}/orders` : "/"}
                    >
                      <NavDropdown.Item>Orders</NavDropdown.Item>
                    </LinkContainer>

                    <LinkContainer
                      to={`/sellerAllProducts/${localStorage.getItem(
                        "sellerToken"
                      )}`}
                    >
