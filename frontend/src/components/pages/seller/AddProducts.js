...
const AddProducts = () => {
    ...
    return (
        <>
            ...
            <Link to={`/sellerAllProducts/${localStorage.getItem('sellerToken')}`}
                style={goBack}><svg xmlns="http://www.w3.org/2000/svg"
                    width="25"
                    height="25"
                    fill="currentColor"
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <Form.Group className='row'>
                        ...
                        <Form.Group className='col'>
                            ...
                            <Form.Group>
                                <Form.Label>Product details</Form.Label><br />
                                ...
                                <FloatingLabel
                                    ...
                                    label='Briefly summarize your product' >
                                    <Form.Control
                                        as='textarea'
                                        placeholder='Briefly'
