...
export const getBuyerProducts = (productType) =>
    async (dispatch) => {
        ...
        try {
            axios.get(`http://localhost:5000/api/product/getProducts/${productType}`, config)
                .then((res) => {
                    dispatch({
...
export const getProductDetail = (productId) =>
    async (dispatch) => {
        ...
        try {
            axios.get(`http://localhost:5000/api/product/productDetail/${productId}`, config)
                .then((res) => {
                    dispatch({
...
export const giveReviewsAction = (productId, name, rating, comment) => async (dispatch) => {
    const config = {
        headers: {
            'content-type': 'application/json',
    ...
    try {
        axios.post(`http://localhost:5000/api/product/${productId}/rating`, body, config)
            .then((res) => {
                dispatch({
...
export const addToTheCartAction = (productId, title, amount, stock, image) => async (dispatch) => {
    const config = {
        headers: {
            'auth-token': localStorage.getItem('jwtToken'),
            'content-type': 'application/json'
    ...
    try {
        ...
        axios.post(`http://localhost:5000/api/product/addCart/${productId.id}`, body, config)
            .then((res) => {
                dispatch({
...
export const getProductFromCartAction = () => (dispatch) => {
    ...
    try {
        axios.get(`http://localhost:5000/api/product/cardList`, config)
            .then((res) => {
                dispatch({
...
export const deleteCart = (productId) => (dispatch) => {
    ...
    try {
        ...
        axios.delete(`http://localhost:5000/api/product/deleteCart/${productId}`, config)
            .then((res) => {
                dispatch({
...
export const updateCartAction = (quantity, productId) => (dispatch) => {
    ...
    try {
        axios.put(`http://localhost:5000/api/product/updateQuantity/${productId}`, body, config)
            .then((res) => {
                dispatch({
